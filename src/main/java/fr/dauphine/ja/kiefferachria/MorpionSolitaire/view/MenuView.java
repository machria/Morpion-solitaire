...
public class MenuView extends JPanel {
	...
	public MenuView(Score score) {
		...
		c.weightx = 0.1;
		c.weighty = 0.1;
		this.add(this.reset = new JButton("RESET",new ImageIcon(this.getClass().getResource("src/main/img/reset.png"))),c);
		c.gridx=0;
		c.gridy=6;
		c.fill = GridBagConstraints.HORIZONTAL;
		c.gridwidth=1;
		c.weightx = 0.1;
		c.weighty = 0.1;
		this.help = new JButton("HELP",new ImageIcon(this.getClass().getResource("src/main/img/help.png")));
		...
		c.weightx = 0.1;
		c.weighty = 0.1;
		this.solution = new JButton("SOLUTION",new ImageIcon(this.getClass().getResource("src/main/img/solution.png")));
		...
		c.weightx = 0.1;
		c.weighty = 0.1;
		this.sauvegarder = new JButton("SAVE",new ImageIcon(this.getClass().getResource("src/main/img/save2.png")));
		...
		c.weightx = 0.1;
		c.weighty = 0.1;
		this.importer = new JButton("IMPORT",new ImageIcon(this.getClass().getResource("src/main/img/import.png")) );
		...
		c.weightx = 0.1;
		c.weighty = 0.1;
		this.scoreDistrib = new JButton("DISTRIBUTION", new ImageIcon(this.getClass().getResource("src/main/img/distribution.png")));
